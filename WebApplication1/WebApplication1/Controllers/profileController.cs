...
namespace WebApplication1.Controllers
{
    ...
    public class profileController : ControllerBase
    {
        ...
        private async Task<string> WriteFile(IFormFile file)
        {
            ...
            var filepath = @"C:\Users\Sayed\Desktop\FinalONE\FinalONEfromSayed\public\imgs";
        ...
        private async Task<string> cv(IFormFile file)
        {
            ...
            // Define your desired path
            var filepath = @"C:\Users\Sayed\Desktop\FinalONE\FinalONEfromSayed\public\cv";
        ...
        public async Task<IActionResult> DownloadCV(string userId)
        {
            ...
            var filePath = Path.Combine(@"C:\Users\Sayed\Desktop\FinalONE\FinalONEfromSayed\public\cv", user.CV);
