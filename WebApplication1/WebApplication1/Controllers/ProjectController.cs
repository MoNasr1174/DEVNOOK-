...
namespace WebApplication1.Controllers
{
    ...
    public class ProjectController : ControllerBase
    {
        ...
        public async Task<IActionResult> UploadFile(IFormFile file, string Brief)
        {
            ...
            {
                FilePath = @"C:\Users\Sayed\Desktop\FinalONE\FinalONEfromSayed\public\ProjectFiles",
                FileName = filename,
                UserId = userId,
                UserName = username,
                Status = "Pending",
        ...
        public async Task<IActionResult> Downloadproject(int projectid)
        {
            ...
            var filePath = Path.Combine(@"C:\Users\Sayed\Desktop\FinalONE\FinalONEfromSayed\public\ProjectFiles", project.FileName);
